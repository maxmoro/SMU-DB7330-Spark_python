...
dbutils.fs.mkdirs("/dbfs/mnt/blob/timelogs")
...
println("Open with")
println("https://dbc-b260fb76-33af.cloud.databricks.com" + logFileName + "?o=6744756749927366")
