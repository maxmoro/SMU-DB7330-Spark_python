...
```{r echo=FALSE, results='asis'}
plot_environments_multi(filter(filtered,subType!='Mathematics'),title=paste0(title),ncol=1,ngroups=2)
plot_environments_multi(filter(filtered,subType=='Mathematics'),title=paste0(title),ncol=1,ngroups=1)
