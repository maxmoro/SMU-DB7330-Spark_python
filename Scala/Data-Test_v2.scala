...
var file_loc = "/dbfs"
var file_prefix = "/mnt/blob/datasets/"
...
var logFileName ="/dbfs/mnt/blob/timelogs/time_Scala_" +randomizeText + '_' + file_name + "_" + now + ".csv"
...
println("Open with")
println("https://community.cloud.databricks.com" + logFileName + "?o=6744756749927366")
